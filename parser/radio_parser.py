...
class RadioParser:
    ...
    def build_aliases(self):
        ...
        manual_aliases = {
            ...
            "10-17": [
                ...
                "dix dix sept",
                "code 17",
                "autorisation de tirer sur les pneus",
            ],
            "10-19": [
                "10 19",
                "10-19",
    ...
    def has_10_19_context(self, text_clean):
        """
        Sécurité radio : 10-19 = accident.
        Si Whisper entend mal le numéro mais que le call parle clairement d'un accident,
        on privilégie 10-19 au lieu de laisser partir sur 10-10.
        """
        accident_patterns = [
            r"\baccident\b",
            r"\baccidente\b",
            r"\baccidentee\b",
            r"\baccidentes\b",
            r"\bvehicule accidente\b",
            r"\bvehicule accidentee\b",
            r"\bvoiture accidente\b",
            r"\bvoiture accidentee\b",
            r"\bvehicule dans le decor\b",
            r"\bvoiture dans le decor\b",
        ]
    ...
    def parse_context_priority(self, text_clean):
        if self.has_10_19_context(text_clean):
            signification = self.codes.get("10-19")

            if signification:
                return "10-19", signification
    ...
    def parse(self, text: str):
        ...
        context_code, context_signification = self.parse_context_priority(text_clean)

        if context_code:
            return context_code, context_signification
